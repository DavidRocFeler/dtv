...
interface ListCardScrollProps {
  items?: IMovieDataProps[]; // Hacer items opcional
}

const ListCardScroll: React.FC<ListCardScrollProps> = ({ items = [] }) => {
  ...
  return (
    ...
    >
      ...
      >
        <style jsx global>{`
          #ListCardScroll::-webkit-scrollbar {
            display: none;
          }
        `}</style>
